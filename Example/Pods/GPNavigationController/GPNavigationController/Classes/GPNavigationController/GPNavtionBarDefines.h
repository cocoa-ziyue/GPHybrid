...
#ifndef GPNavtionBarDefines_h
#define GPNavtionBarDefines_h

//************* 自定义导航栏设置  ***********/
#define Nav_Left @"Nav_Left"         //左侧按钮是图片
#define Nav_LeftTxt @"Nav_LeftTxt"   //左侧按钮是文字
